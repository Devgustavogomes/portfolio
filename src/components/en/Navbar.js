...
export default function Navbar() {
    ...
    return (
        <nav className="w-full px-5 py-4 bg-div2">
            <div className="flex items-center justify-between mx-auto max-w-7xl md:justify-normal">
                ...
                <div className="flex items-center justify-between flex-1 md:justify-start">
                    <p>
                        <span className="text-2xl font-bold text-azulGustavo">GUS</span>
                        <span className="text-2xl font-bold text-azulGustavo2">T</span>
